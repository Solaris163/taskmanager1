...
echo " Вносить изменения может только пользователь boss. ";
ActiveForm::end();
echo "Оставлять комментарии и изображения к задаче может любой, даже без авторизации. <br>";
...
if ($pictures) //проверка, есть ли изображения к этой задаче
{
    ...
    {
        echo "<a href=\"/img/{$picture["name"]}\" target=\"_blank\"><img src=\"/img/small/{$picture["name"]}\" alt = \"изображение\" ></a> &nbsp;";
    }
